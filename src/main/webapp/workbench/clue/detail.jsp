...
<script type="text/javascript">
	...
	$(function(){
		...
		ShowActivityList();
		$("#ShowAllActivity").click(function () {
					...
					$.ajax({
						...
						success:function (resp) {
							...
							$.each(resp,function (index,elemt) {
										html +='<tr>';
										html +='<td><input type="checkbox" name="xz" value="'+elemt.id+'"/></td>';
										html +='<td>'+elemt.name+'</td>';
		...
		$("#AllActivity").on("click",$("input[name = xz]"),function () {
			$("#qx").prop("checked",$("input[name = xz]").length == $("input[name = xz]:checked").length)
		})
		$("#boundBtn").click(function () {
			var data = "clueId=${requestScope.clue.id}"+"&";
	...
	function deleteActivity(id) {
		if(confirm("确定要解除吗？？？")){
			$.ajax({
				url:"workbench/Clue/deleteActivityList.do",
				data:{"id":id},
				dataType:"json",
				type:"post",
				success:function (resp) {
		...
		$.ajax({
			...
			success:function (resp) {
				...
				$.each(resp,function (index,elemt) {
					...
					html +='<td>'+elemt.endDate+'</td>';
					html +='<td>'+elemt.owner+'</td>';
					html +='<td><a href="javascript:void(0);"  style="text-decoration: none;" onclick="deleteActivity(\''+elemt.id+'\')"><span class="glyphicon glyphicon-remove"></span>解除关联</a></td>';
					html +='</tr>';
				})
...
<body>
	...
	<div style="position: relative; top: -70px;">
		...
		<div style="position: relative; left: 40px; height: 30px; top: 10px;">
			...
			<div style="width: 300px;position: relative; left: 650px; top: -60px;"><b><b>${requestScope.clue.job}</b></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px;"></div>
			<div style="height: 1px; width: 400px; background: #D5D5D5; position: relative; top: -60px; left: 450px;"></div>
		</div>
	...
	<div>
		<div style="position: relative; top: 60px; left: 40px;">
			...
			<div>
				<a href="javascript:void(0);" id="ShowAllActivity" style="text-decoration: none;"><span class="glyphicon glyphicon-plus"></span>关联市场活动</a>
			</div>
		</div>
	</div>
